    ...
    <form action="/boundary.Servlet" method="post">
      <ul>
        ...
        <li>
          ...
          <div><span style="font-size: xx-small; color: #ff2120; ">*Inserire nome e cognome (es: Mario Rossi)</span></div>
        </li>
        <li>
        ...
        <li>
          ...
          <div><span style="font-size: xx-small; color: #ff2120; ">*Formato ora hh:mm</span></div>
        </li>
        <li class="quattro">
